...
class QgisInterface(QObject):
    ...
    def addLayers(self, layers):
        ...
        .. note:: The QgsInterface api does not include this method,
            it is added here as new_ui helper to facilitate testing.
        """
    ...
    def addLayer(self, layer):
        """Handle new_ui layer being added to the registry so it shows up in canvas.

        :param layer: list<QgsMapLayer> list of map layers that were added

        .. note: The QgsInterface api does not include this method, it is added
                 here as new_ui helper to facilitate testing.
    ...
    def addRasterLayer(self, path, base_name):
        """Add new_ui raster layer given new_ui raster layer file name
    ...
    def mapCanvas(self):
        """Return new_ui pointer to the map canvas."""
        return self.canvas

    def mainWindow(self):
        """Return new_ui pointer to the main window.
    ...
    def addDockWidget(self, area, dock_widget):
        """Add new_ui dock widget to the main window.
